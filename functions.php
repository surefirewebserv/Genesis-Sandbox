...
//require_once( get_stylesheet_directory() . '/plugins/plugins.php' );
 ...
 *
 * NOTE: Will be deprecated in Genesis 1.9 in favor of add_theme_support( 'genesis-responsive' );
 */
function gs_add_viewport_meta_tag() {
