...
sf_duplicate_menu( jQuery('.nav-responsive ul'), jQuery('#pull'), 'mobile_menu', 'et_mobile_menu' );
sf_duplicate_menu( jQuery('.subnav-responsive ul'), jQuery('#subpull'), 'sub_mobile_menu', 'et_mobile_menu' );
